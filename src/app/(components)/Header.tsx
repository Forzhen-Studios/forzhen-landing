...
export default function Header() {
  return (
    <header className="w-full flex items-center justify-between px-5 py-4 fixed z-20">
      ...
      <Link
        href="/about"
        className="flex group items-center px-4 py-2 rounded-full text-neutral-950 border border-neutral-950 hover:bg-neutral-950 hover:text-neutral-50 transition-colors duration-300"
      >
